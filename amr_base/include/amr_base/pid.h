...
#include <amr_base/ParametersConfig.h>
...
namespace amr_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(amr_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(amr_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<amr_base::ParametersConfig> DynamicReconfigServer;
